...
// I added format parameter because default detection is too simple and fails
int mbedtls_x509_crt_parse(mbedtls_x509_crt *chain, const unsigned char *buf, size_t buflen, int format);
 ...
 */
int mbedtls_x509_crt_parse_file(mbedtls_x509_crt *chain, const char *path, int format);
